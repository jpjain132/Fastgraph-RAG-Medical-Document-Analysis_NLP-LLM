...
NEO4J_PASSWORD = os.getenv("NEO4J_PASSWORD")   # Your neo4j instance password
...
def main():
    # Paths
    xml_file = r"E:\semester 4\FastGraphRAG-Medical-Document-Analysis\neo4j_graph\medical_graph.graphml"
    json_file = r"E:\semester 4\FastGraphRAG-Medical-Document-Analysis\neo4j_graph\medical_graph.json"
